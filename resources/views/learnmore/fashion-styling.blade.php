    ...
    <section class="single-course-section">
        <div class="single-course-container">
            ...
            <div class="single-course-image-wrapper">
                <img src="/assets/fss.png" alt="fashion styling Course">
            </div>

            <!-- Column 2: Course Details -->
            <div class="single-course-details-wrapper">
                <h2 class="single-course-title">Fashion Styling (4 Months)</h2>
                ...
                <div class="single-course-description">
                    <p>
    The Fashion Styling course teaches you how to create visually appealing and trend-focused looks for photoshoots, events, personal clients, and social media content. 
    You will learn body types, color theory, outfit coordination, accessorizing, wardrobe planning, and current fashion trends. 
    The course also covers photo styling, celebrity styling basics, draping techniques, and how to build a professional styling portfolio. 
    With practical sessions and real-world styling exercises, students gain the confidence and creativity to work as personal stylists, fashion influencers, image consultants, or freelance fashion stylists.
</p>
