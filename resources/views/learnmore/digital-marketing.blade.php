    ...
    <section class="single-course-section">
        <div class="single-course-container">
            ...
            <div class="single-course-image-wrapper">
                <img src="/assets/dm.png" alt="digital marketing Course">
            </div>

            <!-- Column 2: Course Details -->
            <div class="single-course-details-wrapper">
                <h2 class="single-course-title">Digital Marketing (3 Months)</h2>
                ...
                <div class="single-course-description">
                    <p>
    Learn the core skills required to build a strong digital presence and grow any business online. 
    This Digital Marketing Course covers social media marketing, SEO basics, content creation, 
    Google Ads, Facebook Ads, website optimization, analytics, and branding strategies. 
    You will understand how to plan and run marketing campaigns, analyze audience behavior, 
    manage business pages professionally, and use digital tools to increase reach and conversions. 
    Practical assignments and real-world case studies help you develop hands-on expertise 
    in modern digital marketing techniques.
</p>
